...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2025 at 07:01 PM
...
('root', '[{\"db\":\"smc_clinic\",\"table\":\"appointments\"},{\"db\":\"smc_clinic\",\"table\":\"patient\"},{\"db\":\"smc_clinic\",\"table\":\"nurse\"},{\"db\":\"smc_clinic\",\"table\":\"users\"},{\"db\":\"smc_clinic\",\"table\":\"user_sessions\"}]');
...
('root', '2025-04-29 17:01:05', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `smc_clinic`
--
CREATE DATABASE IF NOT EXISTS `smc_clinic` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `smc_clinic`;
